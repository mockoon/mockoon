  ...
  describe('Dockerize single mock', () => {
    ...
    test.it(
      ...
      async () => {
        ...
        expect(dockerfileContent).to.contain(
          'ENTRYPOINT ["mockoon-cli", "start", "--daemon-off", "--disable-log-to-file", "--data", "mockoon-mock1.json", "--container"]'
        );
  ...
  describe('Dockerize multiple mocks', () => {
    ...
    test.it(
      ...
      async () => {
        ...
        expect(dockerfileContent).to.contain(
          'ENTRYPOINT ["mockoon-cli", "start", "--daemon-off", "--disable-log-to-file", "--data", "mockoon-mock1.json", "mockoon-mock2.json", "--container"]'
        );
