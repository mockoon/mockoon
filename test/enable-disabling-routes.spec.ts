...
describe('Enable/disable routes', () => {
  ...
  it('Call untouched route', async () => {
    ...
    await tests.app.client.waitForExist('.menu-column--routes .menu-list .nav-item .nav-link.active.route-disabled', null, true);
  ...
  it('Disabling route /answer', async () => {
    ...
    await tests.app.client.waitForExist('.menu-column--routes .menu-list .nav-item .nav-link.active.route-disabled');
