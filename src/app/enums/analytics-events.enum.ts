...
type AnalyticsEventsNames =
  ...
  'CREATE_ENVIRONMENT' | 'CREATE_ROUTE' | 'CREATE_CUSTOM_HEADER' | 'DUPLICATE_ENVIRONMENT' |
  'DUPLICATE_ROUTE' | 'DELETE_ENVIRONMENT' | 'DELETE_ROUTE' | 'DELETE_CUSTOM_HEADER' |
...
export const AnalyticsEvents: { [keyof in AnalyticsEventsNames]: CollectParams } = {
  ...
  APPLICATION_START: { type: 'event', category: 'application', action: 'start' },
  APPLICATION_FIRST_LOAD: { type: 'event', category: 'application', action: 'first-load' },
  ...
  CREATE_CUSTOM_HEADER: { type: 'event', category: 'create', action: 'custom-header' },
  ...
  DELETE_ENVIRONMENT: { type: 'event', category: 'delete', action: 'environment' },
  DELETE_ROUTE: { type: 'event', category: 'delete', action: 'route' },
  DELETE_CUSTOM_HEADER: { type: 'event', category: 'delete', action: 'custom-header' },
  LINK_ROUTE_IN_BROWSER: { type: 'event', category: 'link', action: 'route-in-browser' },
  ...
  LINK_APPLY_UPDATE: { type: 'event', category: 'link', action: 'apply-update' },
